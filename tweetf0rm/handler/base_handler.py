...
class BaseHandler(object):
	...
	def __init__(self):
		'''
			buckets: defines the sub-structure of the buffer; either ["tweets", "followers", "follower_ids", "friends", "friend_ids", "favorites", "retweets", "mentions", "timelines"]
		'''
		self.buffer = dict()
		self.buckets = ["tweets", "followers", "follower_ids", "friends", "friend_ids", "favorites", "retweets", "mentions", "timelines"]
